package com.muzi.easychatadmin.config;
    ...
    Docket docket() {
        return new Docket(DocumentationType.SWAGGER_2)
                ...
                .apiInfo(new ApiInfoBuilder()
                        //网站标题
                        .title("easychatadmin接口文档")
                        //标题后面的版本号
                        .version("v1.0")
                        .description("easychatadmin接口文档")
                        //联系人信息
                        .contact(new Contact("Muzi", "https://www.easymuzi.cn", "972627721@qq.com"))
                        .build())
                .select()
                //指定接口的位置
